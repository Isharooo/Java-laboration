...
<head>
    ...
    <title>Produkthantering - Admin</title>
    <style>
        * {
            margin: 0;
            padding: 0;
                ...
                <td>
                    <c:choose>
                        <c:when test="${product.stock > 10}">
                            <span class="badge badge-success">I lager</span>
                        </c:when>
                        <c:when test="${product.stock > 0}">
                            <span class="badge badge-warning">Lågt lager</span>
                        </c:when>
                        <c:otherwise>
                            <span class="badge badge-danger">Slutsåld</span>
                        </c:otherwise>
                    </c:choose>
                </td>
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/admin/products?action=delete&id=${product.productId}"
                       ...
                       onclick="return confirm('Är du säker på att du vill ta bort ${product.name}?')">
                        Ta bort
                    </a>
                </td>
            </tr>
